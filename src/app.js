...
function renderAll(){renderSceneTree();renderInspector();renderFiles();draw();$('sceneName').textContent=state.scene?.name||'Cena sem título';$('dirtyState').textContent=state.dirty?'● Modificado':'';}
